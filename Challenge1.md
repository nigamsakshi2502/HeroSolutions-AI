...
<li>Sample Connectionstring : 'Server=tcp:jsn.database.windows.net,1433;Initial Catalog=jsndb1;Persist Security Info=False;User ID=username;Password=password;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;'</li>
