...
<div class="container">
  ...
  <h2 style="margin: 10px 0;font-weight: 700;color: #222222;padding-bottom: 5px;
    ...
    <ul>
     ...
     <p style="margin: 10px 0 15px 0;"><a href="https://github.com/jumpstartninjatech/HeroSolutions-AI/blob/master/Challenge0.md" target="_blank">Challenge 0 </a>– Infrastructure Setup and Verification</p>
